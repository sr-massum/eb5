...
/**
 * ExchangeBridge - 301: Moved Permanently Page
 *
...
// If redirect URL is provided, redirect immediately
...
<main class="flex-grow container mx-auto p-4 md:p-6 flex items-center justify-center">
    <div class="text-center max-w-lg">
        <div class="text-primary text-9xl font-bold mb-4">301</div>
        <h1 class="text-3xl font-bold mb-4">Page Moved Permanently</h1>
        <p class="text-gray-600 dark:text-gray-400 mb-8">
            This page has been permanently moved to a new location. The redirect should happen automatically, but if it doesn't, please use the links below.
        </p>
