...
/**
 * ExchangeBridge - 503: Service Unavailable Page
 *
...
<main class="flex-grow container mx-auto p-4 md:p-6 flex items-center justify-center">
    <div class="text-center max-w-lg">
        <div class="text-primary text-9xl font-bold mb-4">503</div>
        <h1 class="text-3xl font-bold mb-4">Service Unavailable</h1>
        <p class="text-gray-600 dark:text-gray-400 mb-8">
            Our service is temporarily unavailable due to maintenance or high load. Please try again in a few minutes.
        </p>
        ...
        <div class="mt-6">
            <p class="text-gray-600 dark:text-gray-400">
                For urgent matters, contact us via 
