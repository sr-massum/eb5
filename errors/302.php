...
/**
 * ExchangeBridge - 302: Found (Temporary Redirect) Page
 *
...
<main class="flex-grow container mx-auto p-4 md:p-6 flex items-center justify-center">
    <div class="text-center max-w-lg">
        <div class="text-primary text-9xl font-bold mb-4">302</div>
        <h1 class="text-3xl font-bold mb-4">Temporary Redirect</h1>
        <p class="text-gray-600 dark:text-gray-400 mb-8">
            This page has been temporarily moved. You should be redirected automatically to the new location.
        </p>
