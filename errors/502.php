...
/**
 * ExchangeBridge - 502: Bad Gateway Page
 *
...
<main class="flex-grow container mx-auto p-4 md:p-6 flex items-center justify-center">
    <div class="text-center max-w-lg">
        <div class="text-primary text-9xl font-bold mb-4">502</div>
        <h1 class="text-3xl font-bold mb-4">Bad Gateway</h1>
        <p class="text-gray-600 dark:text-gray-400 mb-8">
            The server received an invalid response from an upstream server. We're working to resolve this issue.
        </p>
