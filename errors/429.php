...
/**
 * ExchangeBridge - 429: Too Many Requests Page
 *
...
<main class="flex-grow container mx-auto p-4 md:p-6 flex items-center justify-center">
    <div class="text-center max-w-lg">
        <div class="text-primary text-9xl font-bold mb-4">429</div>
        <h1 class="text-3xl font-bold mb-4">Too Many Requests</h1>
        <p class="text-gray-600 dark:text-gray-400 mb-8">
            You have made too many requests in a short period. Please wait a moment before trying again to help us maintain service quality for everyone.
        </p>
        ...
        <div class="mt-6">
            <p class="text-gray-600 dark:text-gray-400">
                Need immediate assistance? <a href="/contact" class="text-primary hover:underline">Contact us</a> or reach out via 
